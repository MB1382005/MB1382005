...
<table>
<tr>
<td align="center"><strong>3.69 / 4.0</strong><br><sub>GPA</sub></td>
<td align="center"><strong>~90%</strong><br><sub>courses graded A or A−</sub></td>
<td align="center"><strong>× 2 🥈</strong><br><sub>Deep Minds AI — 2nd place</sub></td>
</tr>
</table>

---

Full-spectrum CS student spanning AI/ML, software engineering, systems, and CS theory.  
Best result: **83.51% AUC** stacking ensemble on **301,717** CDC clinical records.  
Also built: bilingual Arabic/English NLP recommender · brain tumor CNN · pharmacy ERP · compiler · Odoo ERP customization.
...
PHP/MySQL · authentication, inventory & reviews modules · AI chatbot for medication alternatives · OOP architecture.

**Odoo ERP** `ERP Customization`  
Business process configuration and module customization on Odoo.

**[Hotel Booking System](https://github.com/MB1382005/cpp-hotel-booking-system)** `C++`  
OOP design, file I/O, and application architecture in C++.

**[C# Platformer Game](https://github.com/MB1382005/csharp-platformer-game)** `C#`  
2D game in C# — game loop, collision detection, OOP design patterns.

### CS Fundamentals

**Compiler Design** `C++`  
Lexer & parser implementation · tokenization · grammar rules and syntax analysis.
...
Web         Flask · PHP · HTML · CSS · JavaScript
...
| ☁️ | AWS Educate — Cloud Foundations *(Apr 2024)* |
